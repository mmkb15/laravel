            ...
            <div class="center-item">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item has-children {{ request()->is('brands*') ? 'active' : '' }}">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item"><a href="{{ route('brands.index') }}"><div class="text">Brand List</div></a></li>
                            <li class="sub-menu-item"><a href="{{ route('brands.create') }}"><div class="text">New Brand</div></a></li>
                        </ul>
                    </li>
