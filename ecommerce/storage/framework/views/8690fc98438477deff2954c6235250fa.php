<?php $__env->startSection('title', $mode === 'create' ? 'Add Brand' : 'Edit Brand'); ?>

<?php $__env->startSection('content'); ?>
<div class="main-content-wrap">
    <div class="ecom-page-header">
        <h3><?php echo e($mode === 'create' ? 'Add Brand' : 'Edit Brand'); ?></h3>
        <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
            <li><a href="<?php echo e(route('dashboard')); ?>"><div class="text-tiny">Dashboard</div></a></li>
            <li><i class="icon-chevron-right"></i></li>
            <li><a href="<?php echo e(route('brands.index')); ?>"><div class="text-tiny">Brands</div></a></li>
            <li><i class="icon-chevron-right"></i></li>
            <li><div class="text-tiny"><?php echo e($mode === 'create' ? 'Add Brand' : 'Edit Brand'); ?></div></li>
        </ul>
    </div>

    <form class="template-form two-col" method="POST" action="<?php echo e($mode === 'create' ? route('brands.store') : route('brands.update',$brand)); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" type="text" name="name" value="<?php echo e(old('name',$brand->name)); ?>" placeholder="Enter brand name" required>
            ...
            <div class="template-field">
                ...
                <div class="template-select">
                    <select id="status" name="status" required>
                        <option value="active" <?php if(old('status',$brand->status ?: 'active') === 'active'): echo 'selected'; endif; ?>>Active</option>
                        <option value="inactive" <?php if(old('status',$brand->status) === 'inactive'): echo 'selected'; endif; ?>>Inactive</option>
                    </select>
                </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-card">
            ...
            <?php endif; ?>
            <div class="template-field">
                <label for="brand-image"><?php echo e($brand->image_url ? 'Replace Image' : 'Upload Image'); ?></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-card">
            ...
            <div class="template-field">
                ...
                <textarea id="description" name="description" placeholder="Write brand description..."><?php echo e(old('description',$brand->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                <button class="tf-button w-full" type="submit"><i class="icon-check"></i><?php echo e($mode === 'create' ? 'Create Brand' : 'Update Brand'); ?></button>
                <a class="tf-button style-2 w-full" href="<?php echo e(route('brands.index')); ?>">Cancel</a>
            </div>
        </div>
    </form>
</div>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH X:\New folder 2.0\WDPF\WDPF70\laravel\ecommerce\resources\views/admin/pages/brand/form.blade.php ENDPATH**/ ?>