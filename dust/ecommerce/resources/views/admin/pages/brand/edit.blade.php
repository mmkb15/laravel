...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data" class="form-style-1">
                @csrf
                @method('PUT')
                    ...
                    <div class="upload-image">
                        <div class="item up-load" id="uploadBox" style="position:relative; overflow:hidden;">
                            <label class="uploadfile" for="image">
                                <span class="icon" id="uploadIcon" style="{{ $brand->image ? 'display:none' : '' }}">
                                    <i class="icon-upload-cloud"></i>
                                </span>
                                <div class="text-tiny" id="uploadText" style="{{ $brand->image ? 'display:none' : '' }}">
                            ...
                            <img id="imagePreview"
                                 ...
                                 alt="Preview"
                                 style="{{ $brand->image ? 'display:block;' : 'display:none;' }} position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); max-width:90%; max-height:90%; object-fit:contain; border-radius:12px;">
                        </div>
                    </div>
                </fieldset>
