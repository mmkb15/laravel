...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-add-product" action="{{ route('coupons.update', $coupon) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="wg-box">
                    <div class="gap22 cols">
                        <fieldset class="code">
                            ...
                            <input class="mb-10" type="text" name="code" value="{{ old('code', $coupon->code) }}" required>
                    ...
                    <div class="gap22 cols">
                        <fieldset class="value">
                            ...
                            <input class="mb-10" type="number" step="0.01" name="value" value="{{ old('value', $coupon->value) }}" required>
                        </fieldset>

                        <fieldset class="min_order">
                            <div class="body-title mb-10">Minimum Order Amount</div>
                            <input class="mb-10" type="number" step="0.01" name="min_order" value="{{ old('min_order', $coupon->min_order) }}">
                        </fieldset>
                    </div>
                    ...
                    <div class="gap22 cols">
                        <fieldset class="max_uses">
                            ...
                            <input class="mb-10" type="number" name="max_uses" value="{{ old('max_uses', $coupon->max_uses) }}">
                        </fieldset>

                        <fieldset class="expires_at">
                            <div class="body-title mb-10">Expires At</div>
                            <input class="mb-10" type="date" name="expires_at" value="{{ old('expires_at', $coupon->expires_at?->format('Y-m-d')) }}">
                        </fieldset>
                    </div>
                    ...
                    <div class="bot flex justify-between gap10 mt-30">
                        ...
                        <button type="submit" class="tf-button w208">Update Coupon</button>
                    </div>
                </div>
            </form>
        </div>
