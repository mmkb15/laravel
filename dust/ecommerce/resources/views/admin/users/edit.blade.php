...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-add-product" action="{{ route('users.update', $user) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="wg-box">
                    <div class="gap22 cols">
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" name="name" value="{{ old('name', $user->name) }}" required>
                    ...
                    <div class="gap22 cols">
                        <fieldset class="password">
                            <div class="body-title mb-10">Password <span class="text-tiny">(leave blank to keep current)</span></div>
                            <input class="mb-10" type="password" name="password">
                        ...
                        <fieldset class="password_confirmation">
                            ...
                            <input class="mb-10" type="password" name="password_confirmation">
                        </fieldset>
                    </div>
                    ...
                    <div class="bot flex justify-between gap10 mt-30">
                        ...
                        <button type="submit" class="tf-button w208">Update User</button>
                    </div>
                </div>
            </form>
        </div>
