...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-add-product" action="{{ route('roles.store') }}" method="POST">
                @csrf
                <div class="wg-box">
                    <fieldset class="name">
                        <div class="body-title mb-10">Role Name <span class="tf-color-1">*</span></div>
                        <input class="mb-10" type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Admin, Customer" required>
                        @error('name')
                    ...
                    <div class="bot flex justify-between gap10 mt-30">
                        ...
                        <button type="submit" class="tf-button w208">Save Role</button>
                    </div>
                </div>
            </form>
        </div>
