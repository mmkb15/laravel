            ...
            <div class="tf-section-2">
                <div class="wg-box">
                    <fieldset class="mb-20">
                        ...
                        <div class="text-tiny mt-4">Do not exceed 255 characters when entering the product name.</div>
                    ...
                    <fieldset class="mb-20">
                        ...
                        <input type="number" name="vendor_id" value="{{ old('vendor_id') }}" placeholder="Enter vendor ID">
                        ...
                        <div class="item up-load">
                            <label class="uploadfile" for="productImages">
                                ...
                                <span class="body-text">
                                    Drop images here or <span class="tf-color">click to browse</span> (multiple allowed)
                                </span>
